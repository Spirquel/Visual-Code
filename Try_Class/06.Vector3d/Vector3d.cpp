...
{
    std::cout << "(" << std::setprecision(3) << this->_x << "," << std::setprecision(3) << "," << this->_y << std::setprecision(3) << this->_z << ")" << std::endl;
}

double static Vector3d::add(Vector3d va, Vector3d vb)
{
...
double static Vector3d::dot(Vector3d v1, Vector3d v2)
{
...
Vector3d static Vector3d::mul(Vector3d va, double t)
{
    double vxx = va._x * t;
    double vyy = va._y * t;
    double vzz = va._z * t;
