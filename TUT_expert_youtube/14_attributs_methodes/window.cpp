...
window::window(std::string t, int w, int h) : title(t) , width(w), height(h)/*dans l'attribut title de ma class windows on injecte le contenu de la variable t (idem pour les deux autres)*/
{
